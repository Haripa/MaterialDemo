...
$(function() {
  ...
  * Plugin initialization
  ...
  $(window).on('keydown', function (event) {
      ...
      else if (event.ctrlKey && event.shiftKey && (event.keyCode == 73 || event.keyCode == 67 || event.keyCode == 85)) {
          
          return false;  //Prevent from ctrl+shift+i
      }
      else if (event.ctrlKey && (event.keyCode == 73 || event.keyCode == 67 || event.keyCode == 85)) {
